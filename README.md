...
* Разделение заданий на по объёму, создание подзадач с собственными сроками выполнения
* Уведомление пользователя о заданиях, которые необходимо завершить к концу текущего дня
* Расспределение приоритетов заданий в матрице Эйзенхауэра
* Предложение выполнить задание из списка заданий с высоким приоритетом, когда задания на день заканчиваются
...
* Интеграция с рекламными сервисами (Google AdMob), платёжными системами (VISA, Mastercard, PayPal)
...
* Резкий спад коронавируса, перевод всех отраслей на очный режим, как результат снижение необходимости в приложении, поддерживающем удобную работу с сервисами для удалённой работы (Zoom, MS Teams)
*	Невозможность спроектировать удобный пользовательский интерфейс 
*	Невозможность наладить интеграцию с платёжными системами и/или рекламными сервисами
